...
if (!class_exists('Sparkle_Demo_Importer_Main')) {
    ...
    class Sparkle_Demo_Importer_Main {
        ...
        public function __construct() {
             ...
             * Constants Define
             */
            define('SPARKLE_DEMOI_VERSION', '1.4.1');
                                ...
                                <div id="sparkle-theme-modal-<?php echo esc_attr($demo_slug) ?>" class="sparkle-theme-modal" style="display: none;">
                                    ...
                                    <div class="sparkle-theme-modal-wrap">
                                        ...
                                        <div class="sparkle-theme-reset-checkbox">
                                            ...
                                            <label>
                                                <input id="checkbox-reset-<?php echo esc_attr($demo_slug); ?>" type="text" placeholder="Type reset"/>
                                                <?php echo esc_html('Reset Website - Please Enter reset to reset database', 'sparkle-demo-importer'); ?>
                                            </label>
                                        </div>
...
/** Construction Light FSE Shortcode */
add_shortcode( 'construction-customizer-slider', 'sparkle_demo_importer_construction_light_customizer_slider' );
function sparkle_demo_importer_construction_light_customizer_slider(){
    ob_start();
    ...
    if ($bannerslider == 'enable') {
        ...
        echo "<p> Slider Not enabled</p>";
    }

    $s2 = ob_get_clean(); // read ob1 ("a" . "b" . "c")
    ob_end_flush();
    return $s2;
}
