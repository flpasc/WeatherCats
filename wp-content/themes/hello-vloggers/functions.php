...
add_action( 'tgmpa_register', 'hello_vloggers_register_required_plugins' );

function hello_vloggers_register_required_plugins() {
    $plugins = array(
        array(
    ...
    $config = array(
        'id'           => 'hello-vloggers',                 // Unique ID for hashing notices for multiple instances of TGMPA.
