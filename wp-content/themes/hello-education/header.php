...
<div id="page" class="site">
	...
	<a class="skip-link screen-reader-text" href="#content">
		<?php esc_html_e( 'Skip to content', 'hello-education' ); ?>
	</a>
					    ...
					    <div class="quickcontact">
				        	<?php
				                ...
				                if(!empty( $phone_number )) { ?>
				                	...
				                	<div class="get-tuch text-left">
				                	    ...
				                	    <ul>
				                	        <li>
				                	            <h4><?php esc_html_e('Phone Number','hello-education'); ?></h4>
				                	        </li>
				                	        <li>
				                	        	<p>
				            ...
				            <?php }  if(!empty( $map_address )) { ?>
				            		...
				            		<div class="get-tuch text-left">
				            		    ...
				            		    <ul>
				            		        <li>
				            		            <h4><?php esc_html_e('Contact Address','hello-education'); ?></h4>
				            		        </li>
				            		        <li>
				            ...
				            <?php }  if(!empty( $email_address )) { ?>
				            		...
				            		<div class="get-tuch text-left">
				            		    ...
				            		    <ul>
				            		        <li>
				            		            <h4><?php esc_html_e('Email Address','hello-education'); ?></h4>
				            		        </li>
				            		        <li>
				            		            <p>
