    ...
    */
    $wp_customize->add_section( 'hello_education_features_services_area_options', array(
      ...
      'priority' => 4,
        ...
        $wp_customize->add_control( new Educenter_Repeater_Controler( $wp_customize, 'hello_education_feature_services_area_settings', array(
            'label'   => esc_html__('Features Services Settings Area','hello-education'),
            'section' => 'hello_education_features_services_area_options',
            'educenter_box_label' => esc_html__('Features Services','hello-education'),
            'educenter_box_add_control' => esc_html__('Add New Services','hello-education'),
        ),
        array(
		...
		*/
        ...
        $wp_customize->add_control( new Educenter_Repeater_Controler( $wp_customize, 'educenter_services_area_settings', array(
            ...
            'educenter_box_label' => esc_html__('Course','hello-education'),
            'educenter_box_add_control' => esc_html__('Add New','hello-education'),
        ),
        array(
            'services_icon' => array(
                'type'      => 'icon',
