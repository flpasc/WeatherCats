	...
	function educenter_setup() {
		...
		*/
		...
		add_theme_support( 'custom-header', array(
			'default-image'      => get_template_directory_uri(  ). '/assets/images/default/pexels-photo-820823.jpeg',
		) );
	}
endif;
...
add_filter('educenter_block_pattern_categories', function(){
	return array(
...
function educenter_admin_editor_style() {
	wp_enqueue_style( 'educenter-block-admin-style', get_template_directory_uri() . '/custom-editor-style.css', array(), date( 'Ymd-Gis', filemtime( get_theme_file_path( 'style.css' ) ) ) );
}
add_action( 'admin_enqueue_scripts', 'educenter_admin_editor_style' );
