...
function galaxis_customize_register( $wp_customize ) {
	...
	$reusable_blocks_choices = array( 0 => esc_html__( 'Select a block', 'galaxis' ) );
		...
		array(
			...
			'description' => wp_kses(
				sprintf(
					...
					__( 'This is the content of the footer block area. You can create or edit the footer block area in the <a href="%s" target="_blank">Reusable Blocks Manager (opens in a new window)</a>.<br>After creating the reusable block, you may need to refresh this customizer page and then select the newly created block.<br>The selected block content will appear on the footer block area.', 'galaxis' ),
			...
			'choices'     => $reusable_blocks_choices,
		)
	);
